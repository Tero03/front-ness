<template>
  <LayoutMain>
    <template #slotLayout>
      <Header
        :titulo="'psicologia'"
        :tituloBoton="'responder test'"
        :abrir="abrirFormulario"
      >
      </Header>

      <Formulario
        :titulo="'Test de mentalidad'"
      ...
      <el-table :data="resultadosTabla" stripe style="width: 100%">
        <el-table-column prop="resultado1" label="Pregunta 1" width="180" />
        <el-table-column prop="resultado2" label="Pregunta 2" width="180" />
        <el-table-column prop="resultado3" label="Pregunta 3" />
        <el-table-column prop="resultado4" label="Pregunta 4" />
        <el-table-column prop="resultado5" label="Pregunta 5 " />
        <el-table-column prop="resultado6" label="Pregunta 6" />
...
import formPsicologia from "./components/formPsicologia.vue";
...
const createFile = async () => {
  const url = "http://127.0.0.1:8000/api/psicologica/guardar";

  const dataForm = {

    id_persona: 1,
    resultado1: formRef.value.form.respuesta1,
    resultado2: formRef.value.form.respuesta2,
    resultado3: formRef.value.form.respuesta3,
    resultado4: formRef.value.form.respuesta4,
    resultado5: formRef.value.form.respuesta5,
    resultado6: formRef.value.form.respuesta6
  };
...
const dataFile = async () => {
  const url = "http://127.0.0.1:8000/api/psicologica/datos";
...
const dataById = async (id) => {
  const url = "http://127.0.0.1:8000/api/psicologica/datosById";
...
const updatePerson = async () => {
  const url = "http://127.0.0.1:8000/api/psicologica/actualizar";
...
const deletePerson = async (id) => {
  const url = "http://127.0.0.1:8000/api/psicologica/eliminar";
