<template>
    <LayoutMain>
      <template #slotLayout> 
        ...
        <Header 
        :titulo="'pruebas en grupo'" 
        :tituloBoton="'ejercicios'"
        :abrir="abrirFormulario">
        
        </Header>
  
        <Formulario :titulo="'Ejercicios en grupo'" v-model:is-open="showForm" :is-edit="formEditing">
          
          <template #slotForm>
            <el-row :gutter="20">
              <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
  
            <formGrupo v-model:is-open="showForm" :is-edit="formEditing"/>
    ...
    import formGrupo from './components/formGrupo.vue'
